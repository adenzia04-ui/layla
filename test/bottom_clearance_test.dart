...
void main() {
  ...
  testWidgets('bottom-anchored content clears the tab bar', (
    ...
    final double buttonBottom = tester
        .getRect(find.byKey(const ValueKey<String>('pinned')))
        .bottom;
    final double barTop = tester.getRect(find.byType(BottomBarPreview)).top;

    expect(
      buttonBottom,
      lessThanOrEqualTo(barTop + 0.5),
      reason:
          'pinned content ends at $buttonBottom but the bar starts at '
